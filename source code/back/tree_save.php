...
$sql="INSERT INTO tree_list (name,cha,worth,insert_time,img)VALUES('".$_POST['name']."','".$_POST['cha']."','".$_POST['worth']."',".time().",'".$image_name."')";
if(mysqli_query($conn,$sql))
	echo '<i class="icon-smile-o"></i>添加成功';
else
	echo '<i class="icon-frown-o"></i>添加失败';
?>  
   </div>
    <h4 class="smaller">页面自动 <a id="href" href="tree_add.php">跳转</a> 等待时间： <b id="wait">3</b></h4> 
