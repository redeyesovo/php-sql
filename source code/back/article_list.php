...
$sql="SELECT count(*) FROM `article_list`";
...
$sql="SELECT * FROM `article_list` LIMIT ".$start.",".$num_rows_page;
...
<form method="post" action="" id="listform">
  ...
  <tr>
    ...
    <td align="center"><a href="article_edit.php?id=<?php echo $row['id'] ?>">修改</a>|<a href="article_delete.php?id=<?php echo $row['id'] ?>">删除</a></td>
  </tr>
  <?php
    }
  }
  ?>
      <tr>
        <td colspan="8">
        <div class="pagelist">
        <a href="article_list.php?page=<?=$pref?>">上一页</a>
        <?php
        ...
        ?>
        <a href="article_list.php?page=<?=$next?>">下一页</a>
        <a href="article_list.php?page=<?=$last?>">尾页</a>
        </div>
        </td>
      </tr>
    </table>
