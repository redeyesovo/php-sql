...
$sql="DELETE FROM article_list where id=".$_GET['id'];

if(mysqli_query($conn,$sql)){
	echo '<i class="icon-smile-o"></i>删除成功';
}
else{
	echo '<i class="icon-frown-o"></i>删除失败';
}

?> 
   </div>
    <h4 class="smaller">页面自动 <a id="href" href="article_list.php?page=1">跳转</a> 等待时间： <b id="wait">3</b></h4> 
