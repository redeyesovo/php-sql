...
$sql="INSERT INTO w_list (name,content,insert_time,img)VALUES('".$_POST['name']."','".$_POST['content']."',".time().",'".$image_name."')";
...
?>  
    ...
    <h4 class="smaller">页面自动 <a id="href" href="w_add.php">跳转</a> 等待时间： <b id="wait">3</b></h4> 
