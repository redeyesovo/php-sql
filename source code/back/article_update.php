...
$sql="UPDATE article_list SET name='".$_POST['name']."',content='".$_POST['content']."' WHERE id=".$_POST['id'];
...
?> 
    ...
    <h4 class="smaller">页面自动 <a id="href" href="article_list.php">跳转</a> 等待时间： <b id="wait">3</b></h4> 
