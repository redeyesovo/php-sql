...
$sql="UPDATE tree_list SET name='".$_POST['name']."',cha='".$_POST['cha']."',worth='".$_POST['worth']."' WHERE id=".$_POST['id'];

if(mysqli_query($conn,$sql))
	echo '<i class="icon-smile-o"></i>修改成功';
else
	echo '<i class="icon-frown-o"></i>修改失败';
?> 
   </div>
    <h4 class="smaller">页面自动 <a id="href" href="tree_list.php">跳转</a> 等待时间： <b id="wait">3</b></h4> 
