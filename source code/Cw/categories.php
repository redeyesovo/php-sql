...
$w_name=NULL;
$w_name=(string)$_GET['w_name'];
if (!$w_name)
	$sql="SELECT * FROM `w_list`";
else
	$sql="SELECT * FROM `w_list` as f where f.name like '%$w_name%'";
...
<div class="super_container">
	...
	<header class="header">
		<div class="header_inner d-flex flex-row align-items-center justify-content-start">
			<div class="logo"><a href="#">价值</a></div>
			<div class="header_content ml-auto">
				<div class="search header_search">
					<form action="categories.php" method="GET">

						<input type="text" name="w_name" class="search_input">
				...
				<div class="col-12">
					...
					<div class="sidebar_left clearfix">
						...
						<div class="sidebar_section">
							<div class="sidebar_title">分类</div>
						...
						<div class="product">
							...
							<div class="product_content clearfix">
								<div class="product_info">
									<div class="product_name"><a href="introduction.php?w_test_id=<?php echo $row['id'] ?>"><?php echo $row['name'] ?></a></div>
								</div>
