...
if (!$tree_name)
	...
	$sql="SELECT * FROM `tree_list` as f where f.name like '%$tree_name%'";
...
<div class="super_container">
	...
	<header class="header">
		<div class="header_inner d-flex flex-row align-items-center justify-content-start">
			<div class="logo"><a href="#">树木</a></div>
						...
						<div class="product">
							...
							<div class="product_content clearfix">
								<div class="product_info">
									<div class="product_name"><a href="introduction.php?tree_test_id=<?php echo $row['id'] ?>"><?php echo $row['name'] ?></a></div>
								</div>
